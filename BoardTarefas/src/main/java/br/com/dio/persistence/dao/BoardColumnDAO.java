    ...
    public List<BoardColumnEntity> findByBoardId(final Long boardId) throws SQLException {
        ...
        try (var statement = connection.prepareStatement(sql)) {
            ...
            while (resultSet.next()) {
                ...
                entity.setKind(findByName(resultSet.getString("kind")));/*Criar metodo no Enum pois vai transformá-lo em String*/
                entities.add(entity);
            }
            return entities;
        }
...
//                dto.setOrder(resultSet.getInt("order"));
//                dto.setKind(findByName(resultSet.getString("kind")));/*Criar metodo no Enum pois vai transformá-lo em String*/
                dtos.add(dto);
            }
            return dtos;
        }
